...
byte A[NB_ROWS] = {
	B00000000,B00111100,B01100110,B01100110,
	B01111110,B01100110,B01100110,B01100110
};
byte B[NB_ROWS] = {
	B01111000,B01001000,B01001000,B01110000,
	B01001000,B01000100,B01000100,B01111100
};
byte C[NB_ROWS] = {
	B00000000,B00011110,B00100000,B01000000,
	B01000000,B01000000,B00100000,B00011110
};
byte D[NB_ROWS] = {
	B00000000,B00111000,B00100100,B00100010,
	B00100010,B00100100,B00111000,B00000000
};
byte E[NB_ROWS] = {
	B00000000,B00111100,B00100000,B00111000,
...
byte G[NB_ROWS] = {
	B00000000,B00111110,B00100000,B00100000,
	B00101110,B00100010,B00111110,B00000000
};
byte H[NB_ROWS] = {
	B00000000,B00100100,B00100100,B00111100,
	B00100100,B00100100,B00100100,B00000000
};
byte I[NB_ROWS] = {
	B00000000,B00111000,B00010000,B00010000,
	B00010000,B00010000,B00111000,B00000000
};
byte J[NB_ROWS] = {
	B00000000,B00011100,B00001000,B00001000,
	B00001000,B00101000,B00111000,B00000000
};
byte K[NB_ROWS] = {
	B00000000,B00100100,B00101000,B00110000,
	B00101000,B00100100,B00100100,B00000000
};
byte L[NB_ROWS] = {
	B00000000,B00100000,B00100000,B00100000,
	B00100000,B00100000,B00111100,B00000000
};
byte M[NB_ROWS] = {
	B00000000,B00000000,B01000100,B10101010,
	B10010010,B10000010,B10000010,B00000000
};
byte N[NB_ROWS] = {
	B00000000,B00100010,B00110010,B00101010,
	B00100110,B00100010,B00000000,B00000000
};
byte O[NB_ROWS] = {
	B00000000,B00111100,B01000010,B01000010,
	B01000010,B01000010,B00111100,B00000000
};
byte P[NB_ROWS] = {
	B00000000,B00111000,B00100100,B00100100,
...
byte S[NB_ROWS] = {
	B00000000,B00111100,B00100000,B00111100,
	B00000100,B00000100,B00111100,B00000000
};
byte T[NB_ROWS] = {
	B00000000,B01111100,B00010000,B00010000,
	B00010000,B00010000,B00010000,B00000000
};
byte U[NB_ROWS] = {
	B00000000,B01000010,B01000010,B01000010,
	B01000010,B00100100,B00011000,B00000000
};
byte V[NB_ROWS] = {
	B00000000,B00100010,B00100010,B00100010,
	B00010100,B00010100,B00001000,B00000000
};
byte W[NB_ROWS] = {
	B00000000,B10000010,B10010010,B01010100,
...
byte Y[NB_ROWS] = {
	B00000000,B01000100,B00101000,B00010000,
	B00010000,B00010000,B00010000,B00000000
};
byte Z[NB_ROWS] = {
	B00000000,B00111100,B00000100,B00001000,
...
{ 
	...
	for (byte indRow = 0; indRow < NB_ROWS; indRow++)
	{
		...
		for (uint8_t indReg = 0; indReg < NB_INPUT_ADDR ; indReg++ ) {
			digitalWrite(
				matrixDef[matrixNb].row[indReg], matchAdress[indRow][indReg]
			);  
		}
			...
			for (uint8_t indLed = 0; indLed < NB_OUTPUT_ADDR ; indLed++ ) {
				...
				if ((dataToWrite[indRow] >> indBit) & 0x01) {
					...
					for (uint8_t indReg = 0; indReg < NB_INPUT_ADDR ; indReg++ ) {
						// delay(100);
						digitalWrite(
							matrixDef[matrixNb].col[indReg], matchAdress[indLed][indReg]
						);
					}
				}
			}
